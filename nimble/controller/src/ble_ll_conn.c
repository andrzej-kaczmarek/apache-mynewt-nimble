...
conn_tx_pdu:
    ...
    if ((connsm->flags.terminate_ind_rxd) ||
        ...
        transition = BLE_PHY_TRANSITIONX_NONE;
        txend_func = ble_ll_conn_wait_txend;
    } else {
        /* Wait for a response here */
        transition = BLE_PHY_TRANSITIONX_TO_RX;
        txend_func = NULL;
    }
    ...
    ble_phy_transition_set(transition);
                             ...
                             uint8_t ext)
{
    ...
    ble_phy_transition_set(ext ? BLE_PHY_TRANSITIONX_TO_RX :
